/* 
# 2026 Actual Shipment Manifest
1. Purpose
  - Removes all placeholder/dump data.
  - Populates registry with realistic 2026 logistics entries.
2. Content
  - 5 Major Shipments (Jan - Mar 2026)
  - 10+ Realistic Truck/Equipment Units
*/

-- 1. CLEAN SLATE: Remove all existing records
TRUNCATE TABLE shipment_units_20240218 CASCADE;
TRUNCATE TABLE shipment_headers_20240218 CASCADE;

-- 2. INSERT SHIPMENT 1: Jan 12, 2026 (PAID)
WITH h1 AS (
...
-- 3. INSERT SHIPMENT 2: Jan 28, 2026 (UNPAID)
WITH h2 AS (
...
-- 4. INSERT SHIPMENT 3: Feb 14, 2026 (PAID)
WITH h3 AS (
  INSERT INTO shipment_headers_20240218 (soa_date, bl_no, vessel_name, voyage_no, kgs, cbm, amount_php, is_paid, payment_date)
...
-- 5. INSERT SHIPMENT 4: Feb 25, 2026 (UNPAID)
WITH h4 AS (
  INSERT INTO shipment_headers_20240218 (soa_date, bl_no, vessel_name, voyage_no, kgs, cbm, amount_php, is_paid)
...
-- 6. INSERT SHIPMENT 5: Mar 05, 2026 (PAID)
WITH h5 AS (
  INSERT INTO shipment_headers_20240218 (soa_date, bl_no, vessel_name, voyage_no, kgs, cbm, amount_php, is_paid, payment_date)
